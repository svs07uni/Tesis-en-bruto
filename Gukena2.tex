...
\label{Gukena2}
\cambiar{Repite textualmente lo que dice en el resumen, la motivación y el cap 4.}
\cambiar{De qué fuentes se obtuvieron estas experiencias? fueron realizadas por la tesista?}
\cambiar{En la primera experiencia no se sabe si se usó Gukena como prototipo para ver si funcionaba o se utilizó realmente. Puesto que hablan de que validaron los resultados con un xls.}
\cambiar{No existe una comparativa en como se hacía antes de Gukena y como después, es decir, cuánto se tardaba antes y ahora. O cómo evolucionó el uso de este sistema, con los años. Si bien hay figuras, estas no están bien explicadas.}
\cambiar{Este es un capítulo fuerte de la tesis. Debería tener mucha más presencia y más producción. Por ejemplo, en capítulos anteriores se analizó usabilidad vs integridad vs confiabilidad, y con Gukena? Solo se analiza la tasa de error de la carga de las autoridades de mesa.}
...
\cambiar{Luego se analiza la velocidad de carga, pero son comparables con elecciones de mucha más población? ¿Por qué restan 2 horas? ¿de dónde se obtiene ese número?}
\cambiar{“Gukena al no involucrarse en las etapas de emisión del voto y en el escrutinio de la mesa, logró una buena curva del escrutinio como en Neuquén, sin poner en riesgo la integridad del voto.” pero la población lo consideró confiable?}
