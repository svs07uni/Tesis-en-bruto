...
\section{Motivación}
%\cambiar{Sección 1.1. La motivación no debe describir el trabajo, sino lo que motivó la decisión de realizar un trabajo de estas características. - HECHO: pk:verbos a futuro}
...
%\cambiar{Sección 1.2. No se definen objetivos específicos (revisar plan de tesis presentado). - HECHO}
...
%\cambiar{Sección 1.3: Falta mencionar Capítulo 6, el cual posee conclusiones y trabajo futuro - HECHO}
...
%\cambiar{A su vez, la descripción del contenido de cada capítulo no refleja lo que luego posee el contenido del mismo: - HECHO}
%\cambiar{Capítulo 2, no describe las características de los sistemas tradicionales; describe otros sistemas también. Ver secciones 2.1.1 y otras. - HECHO}
%\cambiar{Capítulo 3, no es una revisión sistemática. Revisar concepto revisión sistemática. Ver:Barbara Kitchenham. Procedures for performing systematic reviews. Technical Report TR/SE-0401, Keele University, Department of Computer Science, Keele University, UK, 2004 - HECHO}