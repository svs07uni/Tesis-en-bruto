...
\cambiar{El gráfico comparativo que hace con Gukena y los otros sistemas electorales no va en las conclusiones.}
...
\cambiar{Repite párrafos completos, ¿otra vez la figura 6.2 y figura 6.3?}
...
\cambiar{Trabajo futuro habla de la boleta única en papel, término casi no explicado y no se entiende que tiene que ver con Gukena.}
